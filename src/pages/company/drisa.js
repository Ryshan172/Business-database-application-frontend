...
const rows = [
  createData("Category", "Sustainable Development"),
  createData("Sub-category", "Research"),
        ...
        <Card className={classes.paper}>
          <CardContent>
            <Typography
              ...
              gutterBottom
            >
              Development and Research Institute for Southern Africa (DRISA){" "}
            </Typography>

            <Typography className={classes.normal} color="black" gutterBottom>
              We promote sustainable development, innovation and research
            </Typography>
          </CardContent>
        </Card>
        <Card className={classes.paper}>
          ...
          <CardContent>
            ...
            <Chip label="Consulting" color="primary" />{" "}
          </CardContent>
        </Card>
        <Card className={classes.paper}>
          <CardContent>
          ...
          <CardContent>
            <List component="nav" className={classes.normal} aria-label="items">
              ...
              >
                ...
                <ListItemText primary="drisa.net" className={classes.normal} />
              </ListItem>
            </List>
          </CardContent>
        </Card>
