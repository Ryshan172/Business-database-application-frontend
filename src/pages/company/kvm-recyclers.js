    ...
    <Grid>
      <Grid>
        ...
        <Card className={classes.paper}>
          ...
          <CardContent>
            <Chip label="Youth Employment" color="primary" />{" "}
            <Chip label="Plastic Recycling" color="primary" />{" "}
          </CardContent>
        </Card>
        <Card className={classes.paper}>
          <CardContent>
          ...
          <CardContent>
            <List component="nav" className={classes.normal} aria-label="items">
              ...
              <ListItem>
                ...
                <ListItemText
                  primary="kvmengineering@telkomsa.net"
                  className={classes.normal}
                />
              </ListItem>
            </List>
